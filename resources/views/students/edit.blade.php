...
<div class="container">
	<div class="row">
		<div class="col-12 text-center pt-5">
			...
			<div class="text-left"><a href="/student_manager" class="btn btn-outline-primary">student List</a></div>
			...
			<form method="post" action="" class="border p-3 mt-2">
				...
				<div class="control-group col-6 text-left mt-2">
					...
					<div>
						<input id="birthday" class="form-control mb-4" name="birthday"  value ="{{$student->birthday}}" required></input>
					</div>
				</div>
				<div class="control-group col-6 text-left mt-2">
